...
public class DBAdapter extends SQLiteOpenHelper {
	...
	private static final String ATTENDANCE_SESSION_TABLE = "attendance_session_table";//faculty
	private static final String ATTENDANCE_TABLE = "attendance_table";//admin
